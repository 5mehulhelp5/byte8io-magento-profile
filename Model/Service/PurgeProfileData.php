...
namespace Byte8\Profile\Model\Service;
...
class PurgeProfileData implements PurgeProfileDataInterface
{
    ...
    private const TABLES_TO_PURGE = [
        'byte8_profile_config',
        'byte8_profile_history',
        'byte8_profile_notification',
        'byte8_profile_notification_summary',
        'byte8_profile_queue',
        'byte8_profile_schedule'
    ];

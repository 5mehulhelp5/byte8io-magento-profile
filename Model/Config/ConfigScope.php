...
use Byte8\Profile\Model\ResourceModel\Config\GetConfigDataInterface;
...
class ConfigScope implements ConfigScopeInterface
{
    ...
    public function __construct(
        ...
        private readonly GetConfigDataInterface $getConfigData,
        private readonly LockGuardedCacheLoader $lockQuery,
    ...
    ): mixed
    {
        ...
        return $this->getConfigData($profileId, $this->generatePath($scope, $path, $scopeCode));
    }
     ...
     * @inheritDoc
     */
    public function getConfigData(int $profileId, string $path = ''): mixed
    {
        $this->setProfileId($profileId);
    ...
    private function initConfigData(): array
    {
        ...
        try {
            ...
            // During installation, stores might not exist yet
            // Return data without fallback processing
            return $data;
        }
    }

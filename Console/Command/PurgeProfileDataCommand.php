...
namespace Byte8\Profile\Console\Command;

use Magento\Framework\Console\Cli;
use Byte8\Profile\Api\Service\PurgeProfileDataInterface;
...
/**
 * Command to purge profile data from byte8_* tables
 */
class PurgeProfileDataCommand extends Command
{
    ...
    protected function configure(): void
    {
        ...
        $this->setDescription('Purge data from byte8_* tables (except byte8_profile_entity)');
        $this->setDefinition([
            new InputOption(
                self::PROFILE_ID,
                null,
        ...
        $this->setHelp(
            <<<HELP
This command purges data from byte8_* tables while preserving profile entities.

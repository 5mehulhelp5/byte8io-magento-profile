...
**Database Table:** `byte8_profile_entity`

```sql
CREATE TABLE byte8_profile_entity (
...
**Database Table:** `byte8_profile_config`

```sql
CREATE TABLE byte8_profile_config (
    entity_id INT AUTO_INCREMENT PRIMARY KEY,
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
        xsi:noNamespaceSchemaLocation="urn:magento:module:Byte8_Profile:etc/profile_type.xsd">
    <profile
...
```
ConfigInterface (Byte8\Profile\Model\Config)
...
Location: `Byte8\Profile\Model\Config\ConfigModel`
...
Location: `Byte8\Profile\Model\Config\ConfigScope`
...
Location: `Byte8\Profile\Model\Config\ConfigScopeWriter`
...
Location: `Byte8\Profile\Ui\DataProvider\Profile\Form\ProfileDataProvider`
...
Location: `Byte8\Profile\Ui\DataProvider\Profile\Form\Modifier\ProfileConfigData`
...
<config>
    <!-- Profile Entity -->
    <preference for="Byte8\Profile\Api\Data\ProfileInterface"
                type="Byte8\Profile\Model\Profile"/>
    <preference for="Byte8\Profile\Api\ProfileRepositoryInterface"
                type="Byte8\Profile\Model\ProfileRepository"/>

    <!-- Configuration -->
    <preference for="Byte8\Profile\Model\Config\ConfigScopeInterface"
                type="Byte8\Profile\Model\Config\ConfigScope"/>
    <preference for="Byte8\Profile\Model\Config\ConfigScopeWriterInterface"
                type="Byte8\Profile\Model\Config\ConfigScopeWriter"/>

    <!-- Type Resolution -->
    <preference for="Byte8\Profile\Model\GetProfileTypeIdInterface"
                type="Byte8\Profile\Model\GetProfileTypeId"/>

    <!-- Profile Types Config -->
    <preference for="Byte8\Profile\Model\ProfileTypes\ConfigInterface"
                type="Byte8\Profile\Model\ProfileTypes\Config"/>
</config>
```
...
```xml
<virtualType name="Byte8\Profile\Model\ProfileTypes\Config\Reader\Virtual"
             type="Magento\Framework\Config\Reader\Filesystem">
    <arguments>
        <argument name="converter" xsi:type="object">
            Byte8\Profile\Model\ProfileTypes\Config\Converter
        </argument>
        <argument name="schemaLocator" xsi:type="object">
            Byte8\Profile\Model\ProfileTypes\Config\SchemaLocator\Virtual
        </argument>
...
│                     Database Layer                               │
│  ┌──────────────────────────┐  ┌──────────────────────────────┐ │
│  │ byte8_profile_    │  │ byte8_profile_config  │ │
│  │ entity                   │  │                              │ │
│  │ ├── entity_id            │  │ ├── entity_id                │ │
│  │ ├── name                 │  │ ├── parent_id ───────────────┼─┤
│  │ ├── type_id              │  │ ├── scope                    │ │

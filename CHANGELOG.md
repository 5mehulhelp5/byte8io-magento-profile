# Changelog — byte8/module-profile
...
> `softcommerce/module-profile`. Versioning is continuous: the line below picks up
> from `3.0.5` and the breaking `4.0.0` release marks the SoftCommerce → Byte8
> rebrand. Releases up to and including `3.0.5` were published under the
> `softcommerceltd` organisation; their compare links point there.
...
[Unreleased]: https://github.com/byte8io/magento-profile/compare/v4.0.0...HEAD
[4.0.0]: https://github.com/byte8io/magento-profile/releases/tag/v4.0.0

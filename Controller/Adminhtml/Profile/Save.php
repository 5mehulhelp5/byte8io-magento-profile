...
use Byte8\Profile\Api\ProfileRepositoryInterface;
use Byte8\Profile\Controller\Adminhtml\Profile as ProfileController;
use Byte8\Profile\Model\Profile as ProfileModel;
use Byte8\Profile\Model\ProfileFactory;
use Byte8\Profile\Model\TypeInstanceOptionsInterface;
use Byte8\Profile\Ui\DataProvider\Profile\Config\Form\ConfigDataScopeStorageInterface;
use Byte8\Profile\Ui\DataProvider\Profile\Form\Modifier\ProfileConfigData;
use Byte8\Profile\Ui\DataProvider\Profile\Form\Modifier\ProfileEntityData;
    ...
    private function saveProfileConfig(): void
    {
        ...
        try {
            $this->_eventManager->dispatch(
                'byte8_profile_config_save_before',
            ...
            $this->_eventManager->dispatch(
                'byte8_profile_config_save_after',

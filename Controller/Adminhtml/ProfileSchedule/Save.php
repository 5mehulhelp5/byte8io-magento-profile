...
use Byte8\Profile\Model\ScheduleFactory;
...
class Save extends Action implements HttpPostActionInterface
{
    ...
    private function processRedirectAfterSuccessSave()
    {
        if ($this->isAjax()) {
            ...
            return $this->resultRedirect('byte8/profileschedule/popup', $params, ['error' => false]);
        }
    ...
    private function processRedirectAfterFailureSave(?string $path = null)
    {
        if ($this->isAjax()) {
            ...
            return $this->resultRedirect('byte8/profileschedule/popup', $request, ['error' => true]);
        }
